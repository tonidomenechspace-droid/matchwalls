...
import { timeline } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate, timeline as timeline2, stagger } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { stagger as stagger2 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate2, stagger as stagger3, inView } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { inView as inView2 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { timeline as timeline3, inView as inView3 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate3 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate4 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { Delegate as Delegate2 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate5 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { Delegate as Delegate3 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
var ProductForm = class extends HTMLFormElement {
  ...
  async _onSubmit(event) {
    ...
    if (window.generalProduct.type === "Mural") {
      const frameImageBlob = await this.captureFrameImage();
      if (frameImageBlob) {
        formData.append('properties[custom_file]', frameImageBlob, 'frame-image.png');
      }
    }
    ...
    if (response.ok) {
      // -----------------------------------------------------------
      // Only for Mural, redirect straight to the cart
      // -----------------------------------------------------------
      if (window.generalProduct.type === "Mural") {
...
async captureFrameImage() {
  ...
  try {
    if (!isReplicated) {
      ...
      console.log('Container and background elements found.');
      ...
      console.log('Container dimensions:', { desiredWidth, desiredHeight });
      ...
      console.log('Offscreen canvas created with dimensions:', {
      ...
      console.log('Background image dimensions:', { imgWidth, imgHeight });

      // Calculate scaling and repetition
      const scale = desiredHeight / imgHeight; // Scale to fit height
      const scaledWidth = imgWidth * scale;
      const scaledHeight = desiredHeight;

      console.log('Scaled dimensions:', { scaledWidth, scaledHeight });

      // Get the scrollLeft position from localStorage
      const scrollLeft = parseFloat(localStorage.getItem('sliderScrollPosition')) || 0;

      console.log('Scroll position (from localStorage):', scrollLeft);

      // Calculate the starting x-offset for the visible portion
      const offsetX = -scrollLeft % scaledWidth; // Modulo to handle repeated pattern
      console.log('Calculated offsetX:', offsetX);

      // Draw the repeated background image
      for (let x = offsetX; x < desiredWidth; x += scaledWidth) {
        console.log('Drawing image at x position:', x);
        ctx.drawImage(backgroundImage, x, 0, scaledWidth, scaledHeight);
      }

      // Return the generated image blob
      const resultBlob = await canvasToBlob(offscreenCanvas, 'image/png');
      console.log('Canvas rendering complete, blob created.');
...
var VariantSku = class extends HTMLElement {
  ...
  const tabSku = document.getElementById("sku-tab-specifications")
  console.log("tabSku: ", tabSku)
  ...
  if (!event.detail.variant) {
    ...
    tabSku.innerText = `${event.detail.variant["sku"]}`
  }
}
...
import { PhotoSwipeLightbox } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//www.matchwalls.com/cdn/shop/t/44/assets/photoswipe.min.js?v=20290624223189769891781683969"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { inView as inView4 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          ...
          <path d="M18.578 32.629a.375.375 0 0 1-.578-.316V15.687c0-.297.328-.476.578-.316l12.931 8.314c.23.147.23.483 0 .63L18.578 32.63Z" fill="#504746"/>
          <path d="M24 .5C36.979.5 47.5 11.021 47.5 24S36.979 47.5 24 47.5.5 36.979.5 24 11.021.5 24 .5Z" stroke="#504746" stroke-opacity=".12"/>
        </svg>
      `));
    }
  }
...
import { timeline as timeline6 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate8 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate9 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
import { animate as animate10, inView as inView5 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
...
// js/theme.js
import { Delegate as Delegate4 } from "//www.matchwalls.com/cdn/shop/t/44/assets/vendor.min.js?v=114992621884149252901781683974";
(() => {
