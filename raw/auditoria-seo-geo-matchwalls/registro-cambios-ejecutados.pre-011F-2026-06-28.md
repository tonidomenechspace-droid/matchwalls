...
- Aprobación exacta recibida: `APROBADO LOTE MW-INDEXABILITY-GEO-COLLECTIONS-NOINDEX-PILOT-011E1`.
- Alcance: piloto reversible de noindex sobre 6 colecciones geográficas no estratégicas.
- No se modificaron handles.
- No se modificaron redirecciones.
- No se modificaron productos, precios, inventario, contenido visible, tema, navegación, traducciones ni canonicals manuales.
...
- Las páginas siguen accesibles directamente; no se eliminaron ni redirigieron.
...
- Geográficas candidatas restantes en sitemap: 310.
  - ES 52.
  - EN 50.
  - FR 51.
  - DE 36.
...
Verificaciones tras reversión:

1. Admin: `seo.hidden = null`.
2. Público: ausencia de robots `noindex`.
3. Sitemap: reaparición tras regeneración/caché si Shopify lo permite.

## Evidencia

- Ejecución: `ejecucion-MW-INDEXABILITY-GEO-COLLECTIONS-NOINDEX-PILOT-011E1-2026-06-27.md`.
- Diagnóstico base: `diagnostico-MW-INDEXABILITY-GEO-COLLECTIONS-DECISION-011E-2026-06-27.md`.
...
- QA público: `qa-publico-MW-INDEXABILITY-GEO-COLLECTIONS-NOINDEX-PILOT-011E1-2026-06-27.csv`.
...
- Diagnóstico de solo lectura sobre colecciones geográficas detectadas en sitemap.
...
- Muestra pública controlada de 28 URLs.
- Muestra Admin GraphQL de colecciones geográficas.

## Estado real comprobado

`VERIFICADO PERO MEJORABLE`

- 346 URLs geográficas siguen presentes actualmente en sitemap:
  - ES 58;
  - EN 56;
  - FR 56;
  - NL 52;
...
- La muestra pública 28/28 responde 200, sin `noindex` y con canonical self.
- La muestra Admin confirma colecciones reales publicadas, `seo.hidden=null`, 73 productos exactos y primeros productos idénticos.

## Riesgo

`RIESGO CRITICO`

- Las páginas geográficas son elegibles para buscadores y sistemas IA, pero muestran patrón masivo/repetitivo.
- Se detectan señales de doorway/geolocalización artificial: misma fecha, mismo surtido inicial, traducciones irregulares, handles localizados con sufijos y bajo valor diferencial.
...
- Mantener en `STANDBY` ciudades estratégicas como Madrid, Barcelona, París, Toulouse y similares hasta disponer de criterio editorial/comercial.
- Ejecutar piloto reversible de noindex en 6 colecciones geográficas no estratégicas:
...
## Aprobación requerida para ejecutar el siguiente lote
...
- Recurso modificado: colección `gid://shopify/Collection/646234440056`.
...
- No se modificaron handles.
- No se modificaron redirecciones.
- No se modificaron plantilla, traducciones, productos, navegación, precios, inventario ni contenido visible.
...
- Valor postcambio:
  - `seo.hidden = 1`;
  - type `number_integer`;
  - updatedAt colección `2026-06-27T09:13:45Z`.
...
- Identificador:
  ...
  - namespace: `seo`;
  - key: `hidden`.
- Mutación de rollback validada en la fase 011D.
- Esto elimina el noindex y permite que Shopify vuelva a incluir la colección en indexación/sitemap si sigue publicada.

## Evidencia

- Propuesta: `propuesta-lote-MW-INDEXABILITY-BLACK-FRIDAY-NOINDEX-011D1-2026-06-27.md`.
- Diagnóstico base: `diagnostico-MW-INDEXABILITY-BLACK-FRIDAY-DECISION-011D-2026-06-27.md`.
...
- QA público: `qa-publico-MW-INDEXABILITY-BLACK-FRIDAY-NOINDEX-011D1-2026-06-27.csv`.
...
- 7/7 contienen señales obsoletas:
  - `Black Friday 2024`;
...
- Tipo: diagnóstico y QA de solo lectura.
- Matriz principal: 17 páginas × 5 idiomas × desktop/mobile = 170 pruebas.
- Anexo técnico: 13 pruebas adicionales sobre home, producto estándar, uploader y tracking.
- Tema QA probado en navegador con preview: `178399019384`, assets `/t/46`.
- Live público sin sesión comprobado por HTTP limpio: home cargó `/t/45` y 0 `/t/46`.
- No se modificó Shopify.
- No se publicó, duplicó, renombró ni eliminó ningún tema.
...
- Roles e IDs se apoyan en verificación 010Z2 y evidencia pública actual de live/preview.
...
- Anexo técnico: 13/13 `CORREGIDO Y VERIFICADO`.
- Tracking `input_mural_outside`: `data-mw010a2d-count=2`, externos/internos sincronizados a `423×223`.

## Incidencias

- No se detectaron incidencias bloqueantes en el alcance probado.
- Incidencia operativa no atribuible a la web: pérdida de una pestaña del navegador interno durante el anexo; el anexo se repitió correctamente con pestaña nueva.
...
No aplica reversión: no hubo escritura ni cambio de estado en Shopify.
...
- Cart ES mobile 390.
- Colección ofertas ES mobile 390.
- Producto estándar ES mobile 390.
...
- Assets QA `/t/46` cargados en las páginas medidas; assets MAIN `/t/45`: 0.
- Consola: 0 errores capturados en todas las páginas de la matriz.
- Overflow real: 0 en todas las páginas medidas.
- Home CSS rastreable: `cssLeak=false`.
- H1, canonical y 8 hreflang presentes en páginas orgánicas críticas probadas.
...
- Cart ES no mostró H1 en esta medición. Estado: `VERIFICADO PERO MEJORABLE`; no bloquea este lote técnico.
- Lectura directa de `window.dataLayer` desde el entorno de inspección: `NO ACCESIBLE`; el marcador QA incorporado confirmó el evento.
...
No aplica reversión: no hubo escritura ni cambio de estado en Shopify.
# 2026-06-26 10:20:37 +02:00 - EjecuciÃ³n MW-TECH-MOBILE-OVERFLOW-SWATCH-TOOLTIP-010C5
...
- AprobaciÃ³n exacta recibida: `APROBADO LOTE MW-TECH-MOBILE-OVERFLOW-SWATCH-TOOLTIP-010C5`.
...
- QA `snippets/variant-picker.liquid` despuÃ©s: MD5 `44af7568d1ddeb65f5fabe7b782c7a05`, size `14968`.
...
Se aÃ±adiÃ³ en `snippets/variant-picker.liquid` una regla mÃ³vil acotada para neutralizar el pseudo-tooltip de swatches dentro de `.product-info__variant-picker`:
...
Motivo: 010C4 demostrÃ³ que `.block-swatch[data-tooltip]::after`, aun invisible, computaba ancho por `content: attr(data-tooltip)` y `white-space: nowrap`, generando overflow mÃ³vil en FR/NL.

## EjecuciÃ³n

- MutaciÃ³n: `themeFilesUpsert`.
- Cuerpo: `BASE64`.
- Resultado Shopify: `userErrors=[]`.
...
- FR uploader mÃ³vil 390: `docScrollWidth=375`, `docClientWidth=375`, overflow `0`.
- FR uploader mÃ³vil 375: `docScrollWidth=360`, `docClientWidth=360`, overflow `0`.
- NL uploader mÃ³vil 390: `docScrollWidth=375`, `docClientWidth=375`, overflow `0`.
- NL uploader mÃ³vil 375: `docScrollWidth=360`, `docClientWidth=360`, overflow `0`.
- ES uploader mÃ³vil 390: overflow `0`.
- EN uploader mÃ³vil 390: overflow `0`.
- DE uploader mÃ³vil 390: overflow `0`.
...
- Assets QA `/t/46`: 11; assets MAIN `/t/45`: 0 en las verificaciones pÃºblicas.
- Consola: 0 errores capturados.

## ValidaciÃ³n y limitaciones

- GraphQL validado contra schema antes de ejecutar.
- Shopify aceptÃ³ el archivo con `userErrors=[]`.
- Readback confirmÃ³ MD5 esperado.
- El validador local `shopify-liquid/scripts/validate.mjs` no pudo completarse por dependencia ausente del runtime (`@shopify/theme-check-common`). Se registra como limitaciÃ³n de herramienta local, no como error del cÃ³digo.
- No se ejecutÃ³ matriz completa de 170 pruebas en este cierre.
...
# 2026-06-26 09:53:05 +02:00 - DiagnÃ³stico MW-TECH-MOBILE-OVERFLOW-VARIANT-SWATCH-DIAG-010C4

## Estado

`VERIFICADO Y CORRECTO` como diagnÃ³stico de causa. La incidencia visual queda `INCOMPLETO` hasta ejecutar un lote de correcciÃ³n.
...
- FR uploader mÃ³vil 390: `docScrollWidth=447`, `docClientWidth=375`, overflow vs `innerWidth` `+57 px`.
- FR uploader mÃ³vil 375: `docScrollWidth=447`, `docClientWidth=360`, overflow vs `innerWidth` `+72 px`.
- NL uploader mÃ³vil 390: `docScrollWidth=427`, `docClientWidth=375`, overflow vs `innerWidth` `+37 px`.
- NL uploader mÃ³vil 375: `docScrollWidth=427`, `docClientWidth=360`, overflow vs `innerWidth` `+52 px`.
...
- Aunque invisible, el tooltip absoluto cuenta para el `scrollWidth` mÃ³vil.
...
PrÃ³ximo lote recomendado: `MW-TECH-MOBILE-OVERFLOW-SWATCH-TOOLTIP-010C5`, escritura acotada a QA para neutralizar el pseudo-tooltip de swatches en mÃ³vil.
...
# 2026-06-25 20:01:31 +02:00 - EjecuciÃ³n MW-TECH-MOBILE-OVERFLOW-RELATED-PRODUCTS-010C3
...
- AprobaciÃ³n exacta recibida: `APROBADO LOTE MW-TECH-MOBILE-OVERFLOW-RELATED-PRODUCTS-010C3`.
- Tema afectado: `gid://shopify/OnlineStoreTheme/178399019384`, rol `UNPUBLISHED`, prefijo `/t/46`.
...
- Se aÃ±adiÃ³ CSS mÃ³vil acotado dentro de `sections/related-products.liquid` para intentar contener el overflow de `scroll-carousel.scroll-area.bleed` en la secciÃ³n `shopify-section--product-recommendations`.
...
## QA crÃ­tica del candidato

`INCORRECTO`

- FR uploader mÃ³vil 390: overflow siguiÃ³ en `+57 px`; assets `/t/46`; assets `/t/45` = 0; consola sin errores.
- NL uploader mÃ³vil 390: overflow siguiÃ³ en `+37 px`; assets `/t/46`; assets `/t/45` = 0; consola sin errores.
- El candidato no resolviÃ³ la incidencia detectada por `MW-TECH-QA-REGRESSION-MATRIX-010Z`.

## Rollback ejecutado

`CORREGIDO Y VERIFICADO`

- Se revirtiÃ³ `sections/related-products.liquid` en el tema QA.
- Primera lectura de rollback detectÃ³ una discrepancia temporal en QA: MD5 `ccd037da6ce4b2f41963e823e3845e48`, size `10699`, causada por una diferencia de clase en una ocurrencia de `animated-arrow--reverse`. No se aceptÃ³ como estado final.
- Se restaurÃ³ de nuevo desde el archivo local verificado contra MAIN.
...
## QA pÃºblica despuÃ©s del rollback

`VERIFICADO PERO MEJORABLE`

- NL uploader mÃ³vil 390: assets `/t/46` = 11, assets `/t/45` = 0, canonical correcto, hreflang = 8, consola sin errores, overflow `+37 px`.
- FR uploader mÃ³vil 390: assets `/t/46` = 11, assets `/t/45` = 0, canonical correcto, hreflang = 8, consola sin errores, overflow `+57 px`.
...
- 010C3 queda rechazado: no publicar, no promover y no reutilizar como soluciÃ³n.
- QA queda estable y revertido al mismo MD5 que MAIN para `sections/related-products.liquid`.
- PrÃ³ximo paso recomendado: `MW-TECH-MOBILE-OVERFLOW-RELATED-PRODUCTS-DIAG-010C4`, diagnÃ³stico de solo lectura para localizar el elemento exacto que genera `scrollWidth` en FR/NL antes de proponer otro cambio.
...
- QA de regresiÃ³n compacta de solo lectura.
...
- Home ES, carrito ES y colecciÃ³n `/collections/ofertas`: assets `/t/46`, 0 assets `/t/45`, canonical/hreflang presentes, consola sin errores.
- Uploader ES/EN/FR/DE/NL desktop: inputs presentes, sincronizaciÃ³n correcta y evento `input_mural_outside` verificado con seÃ±al QA.
- Producto estÃ¡ndar `lineas-noridcas-verde`: inputs presentes, sincronizaciÃ³n correcta y evento `input_mural_outside` verificado.
- Home mÃ³vil ES 390: sin errores de consola y sin fuga CSS visible de home.

## Incidencia

`INCORRECTO`

- Uploader FR mÃ³vil: overflow +57 px a 390 y +72 px a 375.
- Uploader NL mÃ³vil: overflow +37 px a 390 y +52 px a 375.
...
- Se aÃ±adio `pushInputMuralOutsideEvent` junto a los listeners funcionales de `externalWidthInput` y `externalHeightInput`.
- Se aÃ±adio seÃ±al QA `data-mw010a2d-*` limitada a URLs con `mwqa=010a2d`.
...
- Prueba `407 x 307`: sincronizacion correcta y superficie `4.07m x 3.07m = 12.49 mÂ²`.
...
- Superficie visual: `4.05m x 3.05m = 12.35 mÂ²`.
- Errores de consola: `0`.
...
- Respaldo local de `external-selectors.liquid`: MD5 `8a9c233bca52da58ce59fffc3aee8359`, tamaÃ±o `10199`, sin caracteres de control invalidos.
...
- Cambio `402 x 302`: inputs internos sincronizados y superficie `4.02m x 3.02m = 12.14 mÂ²`.
- `window.dataLayer`: no creado.
- Eventos `input_mural_outside`: 0.
- Errores de consola: 0.
...
> **Alcance:** este documento registra ÃƒÂºnicamente lotes concretos ejecutados.
> No certifica que toda la web, todo el catÃƒÂ¡logo o todos los idiomas estÃƒÂ©n
> optimizados. El programa SEO/GEO permanece **EN CURSO - NO CERRADO**.

## 15 de junio de 2026

### Lote MW-SEO-001: pÃƒÂ¡ginas cruzadas

**Estado:** ejecutado y verificado internamente.

**Recursos:**

- `gid://shopify/Page/106278387939` Ã¢â‚¬â€ `MÃƒÂ©todos de pago`
- `gid://shopify/Page/106278256867` Ã¢â‚¬â€ `Conoce nuestros productos`

**Cambios ejecutados:**

- Restaurado el cuerpo espaÃƒÂ±ol de `MÃƒÂ©todos de pago`.
- Restaurado el cuerpo espaÃƒÂ±ol de `Conoce nuestros productos`.
- No se modificaron tÃƒÂ­tulos, handles, plantillas ni estado de publicaciÃƒÂ³n.
- Registrados en `MÃƒÂ©todos de pago` los cuerpos, tÃƒÂ­tulos y metadatos EN, FR, DE y NL que estaban publicados errÃƒÂ³neamente en la pÃƒÂ¡gina de productos.
- Conservados los handles localizados existentes de la pÃƒÂ¡gina de pagos.

**VerificaciÃƒÂ³n:**

- Las dos operaciones `pageUpdate` terminaron sin `userErrors`.
- Las 16 traducciones registradas en la pÃƒÂ¡gina de pagos terminaron sin `userErrors`.
- La lectura posterior confirmÃƒÂ³ que los cuerpos espaÃƒÂ±oles corresponden de nuevo a cada pÃƒÂ¡gina.
- Las traducciones EN, FR, DE y NL de pagos figuran como no desactualizadas.

**Pendiente:**

- Sustituir en `Conoce nuestros productos` los contenidos EN, FR, DE y NL de pagos que todavÃƒÂ­a permanecen como traducciones desactualizadas.
- Validar comercialmente los mÃƒÂ©todos de pago, disponibilidad por paÃƒÂ­s y afirmaciones de seguridad antes de una reescritura definitiva.

### Lote MW-SEO-002: pÃƒÂ¡ginas corporativas y traducciones
...
- Registradas traducciones EN, FR, DE y NL de `MÃƒÂ©todos de pago`.
- Eliminados los H1 incluidos dentro del cuerpo de ambas pÃƒÂ¡ginas para evitar duplicarlos cuando se publique la plantilla corregida.
- No se modificaron handles, URLs, redirecciones ni estado de publicaciÃƒÂ³n.

**LimitaciÃƒÂ³n verificada:**

- El tema principal actual no muestra `page.content` en estas plantillas. Los tÃƒÂ­tulos y metadatos estÃƒÂ¡n activos, pero los cuerpos corregidos requieren publicar una plantilla previamente validada.

### Lote MW-SEO-003: catÃƒÂ¡logo piloto Vista Serena y Whispering Woods

**Estado:** ejecutado y verificado internamente.

**Cambios ejecutados:**

- Corregidos los tÃƒÂ­tulos SEO espaÃƒÂ±oles de los cinco productos Vista Serena.
- Resincronizados tÃƒÂ­tulos y metadatos EN, FR, DE y NL de Vista Serena.
- Resincronizados tÃƒÂ­tulos y metadatos prioritarios de siete productos Whispering Woods.
...
- No se modificaron handles, URLs, imÃƒÂ¡genes, inventario ni reglas comerciales.

### Lote MW-SEO-004: hotfix de datos estructurados

**Estado:** preparado y verificado en tema no publicado; pendiente de publicaciÃƒÂ³n manual.

**Tema:** `SEO schema hotfix - 2026-06-15`.

**Cambios preparados:**

- EliminaciÃƒÂ³n del `AggregateRating` fijo y no demostrable de Organization.
- SupresiÃƒÂ³n de GTIN cuando el barcode coincide con el ID interno de la variante.
- CorrecciÃƒÂ³n del breadcrumb de artÃƒÂ­culos.
- ConservaciÃƒÂ³n de Product, Offer, SKU, disponibilidad, Breadcrumb, WebSite y Organization.

**VerificaciÃƒÂ³n:**

- Producto de prueba: JSON-LD vÃƒÂ¡lido, cuatro ofertas, cuatro SKU, cero GTIN falsos y un H1.
- Home: WebSite y Organization vÃƒÂ¡lidos, sin AggregateRating no demostrable.
- ArtÃƒÂ­culo: BlogPosting y BreadcrumbList vÃƒÂ¡lidos; el tercer breadcrumb corresponde al artÃƒÂ­culo.
- No se ha publicado ni modificado el tema principal.

### AuditorÃƒÂ­as de escala verificadas, sin mutaciones

- 58 colecciones geogrÃƒÂ¡ficas con handle `comprar-papel-pintado-*`.
- Madrid, Barcelona, ParÃƒÂ­s y Toulouse muestran 73 productos y el mismo surtido inicial.
- Se detectÃƒÂ³ mezcla de idiomas y traducciones automÃƒÂ¡ticas defectuosas en pÃƒÂ¡ginas geogrÃƒÂ¡ficas marcadas como actualizadas.
- `Todos los Papeles Pintados` (`/collections/murales`) excluye por regla el tipo `Papel Pintado`; no se cambiÃƒÂ³ por su gran impacto comercial.
...
### Lote MW-SEO-005: quick wins de colecciÃƒÂ³n y familia BambÃƒÂºze

**Estado:** ejecutado y verificado internamente.

**Cambios ejecutados:**

- Corregido el tÃƒÂ­tulo espaÃƒÂ±ol de la colecciÃƒÂ³n `Papeles Pintados ContemporÃƒÂ¡neos`.
- Resincronizados sus tÃƒÂ­tulos EN, FR, DE y NL; mejorado tambiÃƒÂ©n el metatÃƒÂ­tulo NL.
- Corregidos espacios dobles en los tÃƒÂ­tulos y metatÃƒÂ­tulos espaÃƒÂ±oles de `BambÃƒÂºze Negro`, `BambÃƒÂºze Beige` y `BambÃƒÂºze Blanco y Negro`.
- Resincronizados tÃƒÂ­tulos y metatÃƒÂ­tulos EN, FR, DE y NL de esos tres murales.

**GarantÃƒÂ­as:**

- No se modificaron handles, URLs, reglas de colecciÃƒÂ³n, productos asociados ni descripciones de producto.
- Todas las operaciones terminaron sin `userErrors`.
- La lectura posterior confirmÃƒÂ³ que los campos traducidos revisados no estÃƒÂ¡n desactualizados.

### Lote MW-SEO-006: familia LÃƒÂ­neas NÃƒÂ³rdicas

**Estado:** ejecutado y verificado internamente.

**ÃƒÂmbito:** diez murales activos de la familia.

**Cambios ejecutados:**

- Corregido `LÃƒÂ­neas NÃƒÂ³ridcas` a `LÃƒÂ­neas NÃƒÂ³rdicas` en tÃƒÂ­tulos visibles, tÃƒÂ­tulos SEO y descripciones SEO espaÃƒÂ±olas.
- Eliminados espacios dobles en los tÃƒÂ­tulos afectados.
- Reescritos y sincronizados tÃƒÂ­tulos, metatÃƒÂ­tulos y metadescripciones EN, FR, DE y NL.
- Corregida durante el propio lote una sustituciÃƒÂ³n temporal de descripciones SEO causada por el comportamiento de reemplazo completo de `SEOInput`.

**GarantÃƒÂ­as:**

- No se modificaron handles, URLs, redirecciones, inventario, imÃƒÂ¡genes, variantes ni muestras.
- Las diez descripciones SEO espaÃƒÂ±olas fueron comprobadas como no vacÃƒÂ­as.
- Todos los tÃƒÂ­tulos y metadatos traducidos revisados quedaron con `outdated: false`.
- Todas las mutaciones terminaron sin `userErrors`.

**VerificaciÃƒÂ³n pÃƒÂºblica representativa:**

- `/products/lineas-noridcas-marron`: H1 `LÃƒÂ­neas NÃƒÂ³rdicas MarrÃƒÂ³n`, title y metadescripciÃƒÂ³n corregidos, canonical sin cambios.
- `/en/products/brown-noridcas-lines`: H1 `Nordic Lines Brown`, title y metadescripciÃƒÂ³n corregidos, canonical sin cambios.
- `/fr/products/lignes-brunes-de-noridcas`: H1 `Lignes Nordiques Marron`, title y metadescripciÃƒÂ³n corregidos, canonical sin cambios.
- `/de/products/brown-noridcas-linien`: H1 `Nordische Linien Braun`, title y metadescripciÃƒÂ³n corregidos, canonical sin cambios.
- `/nl/products/bruine-noridcas-lijnen`: title y metadescripciÃƒÂ³n corregidos; la comprobaciÃƒÂ³n posterior confirmÃƒÂ³ tambiÃƒÂ©n el H1 renderizado.
- `/products/bambuze-negro`: H1, title, metadescripciÃƒÂ³n y canonical correctos.
- `/collections/lo-mas-contemporaneo-murales`: H1 `Papeles Pintados ContemporÃƒÂ¡neos`, metadatos y canonical correctos.

### ReauditorÃƒÂ­a y correcciÃƒÂ³n del lote MW-SEO-004

**Estado:** corregido y verificado en tema no publicado; no publicado.

- Se comprobÃƒÂ³ que la primera versiÃƒÂ³n del hotfix reescribÃƒÂ­a mÃƒÂ¡s campos de schema de los previstos.
- Se sustituyÃƒÂ³ por una versiÃƒÂ³n mÃƒÂ­nima derivada del schema MAIN.
...
- Se eliminan ÃƒÂºnicamente GTIN/MPN basados en IDs internos, AggregateRating corporativo fijo y el nombre errÃƒÂ³neo del tercer breadcrumb de artÃƒÂ­culos.
- Google Rich Results Test detectÃƒÂ³ 3 elementos vÃƒÂ¡lidos y ningÃƒÂºn error crÃƒÂ­tico.
- Home, producto ES/EN, artÃƒÂ­culo, carrito y formularios fueron comprobados en escritorio y mÃƒÂ³vil.
- `config/settings_data.json` coincide con MAIN; App Embeds no cambiaron.
- Shopify bloqueÃƒÂ³ el borrado de `snippets/microdata-schema-original.liquid`; permanece como copia sin uso del schema MAIN.
- No se modificÃƒÂ³ ni publicÃƒÂ³ el tema MAIN.

**Evidencia detallada:** `qa-hotfix-schema-2026-06-15.md`.

### AprobaciÃƒÂ³n de publicaciÃƒÂ³n del lote MW-SEO-004

**Estado:** aprobado por Daniel; pendiente de publicaciÃƒÂ³n manual.

- Daniel aprobÃƒÂ³ publicar ÃƒÂºnicamente `SEO schema hotfix - 2026-06-15`.
- Daniel aprobÃƒÂ³ conservar temporalmente la copia auxiliar sin uso.
- La comprobaciÃƒÂ³n final confirmÃƒÂ³ rol `UNPUBLISHED`, ausencia de fallos de procesamiento y checksum funcional `58417e4825aa3d4570a6646f292aaedc`.
- La conexiÃƒÂ³n disponible bloquea por seguridad la publicaciÃƒÂ³n automÃƒÂ¡tica de temas.
- `SEO-GEO staging - 2026-06-15` continÃƒÂºa expresamente excluido de publicaciÃƒÂ³n.

### Lote MW-SEO-007: primeras URLs estratÃƒÂ©gicas solicitadas

**Estado:** ejecutado parcialmente y verificado pÃƒÂºblicamente; no equivale a cierre global.

**Recursos modificados:**

- Producto `custom-file-uploader`.
- ColecciÃƒÂ³n `murales-mas-vendidos-mural`.
- PÃƒÂ¡gina `contact`.

**Cambios ejecutados:**

- Reescritos tÃƒÂ­tulo, descripciÃƒÂ³n y metadatos del producto de personalizaciÃƒÂ³n en ES, EN, FR, DE y NL.
- Reescritos tÃƒÂ­tulo, descripciÃƒÂ³n y metadatos de la colecciÃƒÂ³n de papeles pintados y murales mÃƒÂ¡s vendidos en ES, EN, FR, DE y NL.
- Corregida la pÃƒÂ¡gina de contacto en ES, EN, FR, DE y NL, eliminando el H1 duplicado y mejorando tÃƒÂ­tulos, contenido y metadatos.
- No se modificaron handles, URLs, redirecciones, reglas de colecciÃƒÂ³n, productos asociados, variantes ni estado de publicaciÃƒÂ³n.

**VerificaciÃƒÂ³n pÃƒÂºblica:**

- Contacto muestra un ÃƒÂºnico H1 y metadatos localizados correctos en los cinco idiomas prioritarios.
- La colecciÃƒÂ³n muestra el nuevo H1, descripciÃƒÂ³n y metadatos.
- El producto de personalizaciÃƒÂ³n muestra los nuevos metadatos, pero su plantilla publicada continÃƒÂºa ocultando la descripciÃƒÂ³n guardada y mantiene un H1 fijo distinto del tÃƒÂ­tulo del producto.

**Estado real:**

- Contacto: correcciÃƒÂ³n editorial y tÃƒÂ©cnica bÃƒÂ¡sica completada; pendiente QA integral de conversiÃƒÂ³n, accesibilidad y GEO/AEO.
- ColecciÃƒÂ³n mÃƒÂ¡s vendidos: contenido principal corregido; handles localizados y arquitectura pendientes de anÃƒÂ¡lisis con redirecciones.
- Producto de personalizaciÃƒÂ³n: datos corregidos; pendiente correcciÃƒÂ³n y QA de plantilla en tema no publicado.

### AuditorÃƒÂ­a de plantillas de pÃƒÂ¡ginas prioritarias

**Estado:** verificado; correcciones de tema aÃƒÂºn no publicadas.

- La pÃƒÂ¡gina pÃƒÂºblica `muestras` usa `templates/page.muestras-2.json`, no `templates/page.muestras.json`.
- `templates/page.muestras-2.json`: la secciÃƒÂ³n `main-page` estÃƒÂ¡ desactivada; ES muestra texto fijo sin H1 y EN aparece sin contenido principal.
- `templates/page.guias-de-instalacion.json`: la secciÃƒÂ³n `main-page` estÃƒÂ¡ desactivada y el contenido principal SEO/HowTo no es visible.
- La guÃƒÂ­a de instalaciÃƒÂ³n conserva enlaces `file:///C:/Users/...` que no son accesibles para clientes ni buscadores.
- Corregido el HTML roto de la traducciÃƒÂ³n neerlandesa guardada de la guÃƒÂ­a.
- Se probÃƒÂ³ una activaciÃƒÂ³n mÃƒÂ­nima en `templates/page.muestras.json`, se comprobÃƒÂ³ que no era la plantilla asignada y se revirtiÃƒÂ³.
- La lectura posterior muestra el mismo cuerpo funcional que MAIN, con `main-page` desactivado, pero el checksum de staging difiere por la reescritura del archivo. No afecta producciÃƒÂ³n y debe conservarse como diferencia conocida hasta el siguiente QA del tema auxiliar.
- El tema MAIN no se modificÃƒÂ³.

### Lote MW-SEO-008: pÃƒÂ¡ginas estratÃƒÂ©gicas y colecciones de intenciÃƒÂ³n

**Estado:** ejecutado parcialmente y verificado mediante lectura posterior de Shopify; QA pÃƒÂºblica pendiente en las colecciones.

**Cambios ejecutados:**

- Corregido el HTML roto de la guÃƒÂ­a de instalaciÃƒÂ³n neerlandesa.
- Neutralizadas las metadescripciones EN, FR, DE y NL de `Sobre nosotros` para retirar promesas no verificadas de envÃƒÂ­o gratuito, nÃƒÂºmero de diseÃƒÂ±os y materiales.
- Corregido el tÃƒÂ­tulo francÃƒÂ©s de `Sobre nosotros`.
...
- Reescrita la colecciÃƒÂ³n `Papeles pintados para espacios pÃƒÂºblicos` en ES, EN, FR, DE y NL, eliminando la afirmaciÃƒÂ³n no demostrada de aptitud para exteriores.
- Reescrita la colecciÃƒÂ³n `Papel Pintado Floral` en ES, EN, FR, DE y NL, corrigiendo gramÃƒÂ¡tica y retirando enumeraciones de materiales no verificadas para toda la colecciÃƒÂ³n.

**GarantÃƒÂ­as:**

- No se modificaron handles, URLs, redirecciones, reglas de colecciÃƒÂ³n, productos asociados, inventario ni temas publicados.
- Todas las mutaciones terminaron sin `userErrors`.
- Las traducciones registradas quedaron con `outdated: false`.

**Hallazgos pÃƒÂºblicos crÃƒÂ­ticos del lote:**

- Muestras ES no tiene H1; Muestras EN no muestra contenido principal.
- Sobre nosotros FR y NL no muestran contenido principal; DE muestra una traducciÃƒÂ³n fija de baja calidad distinta del contenido guardado.
- FAQ ES tiene dos H1 y varios bloques `FAQPage`; FAQ EN no muestra contenido principal.
- Profesionales ES tiene dos H1 y publica ventajas y plazos pendientes de validaciÃƒÂ³n comercial.
...
### Lote MW-SEO-009: blog raÃƒÂ­z e inventario editorial

**Estado:** metadatos del blog raÃƒÂ­z ejecutados y verificados mediante lectura posterior; artÃƒÂ­culos pendientes de revisiÃƒÂ³n individual.

**Cambios ejecutados:**

- Reescritos metatÃƒÂ­tulo y metadescripciÃƒÂ³n del blog `InspiraciÃƒÂ³n` en ES, EN, FR, DE y NL.
- Reforzada la intenciÃƒÂ³n sobre papel pintado, murales, instalaciÃƒÂ³n y decoraciÃƒÂ³n sin aÃƒÂ±adir afirmaciones comerciales.
- No se modificaron tÃƒÂ­tulo visible, handles, artÃƒÂ­culos, fechas, autores ni estado de publicaciÃƒÂ³n.

**Hallazgos del inventario:**

- Existen 11 artÃƒÂ­culos publicados en el blog espaÃƒÂ±ol.
- Diez artÃƒÂ­culos no tienen resumen guardado.
- El artÃƒÂ­culo de cocina conserva el handle con error `transfroma`.
- Los handles del blog FR y DE conservan sufijos `inspiration-2` e `inspiration-1`.
- El artÃƒÂ­culo `Colores del Papel Pintado: Tendencias 2025` requiere actualizaciÃƒÂ³n de vigencia antes de considerarlo evergreen.

**Pendiente:**

- Revisar cada artÃƒÂ­culo en ES, EN, FR, DE y NL: contenido visible, autorÃƒÂ­a, fecha, resumen, title, meta description, H1-H3, enlaces internos, imÃƒÂ¡genes, Article schema y citabilidad GEO/AEO.
- Cambiar handles ÃƒÂºnicamente con mapa de redirecciones y QA de hreflang.
...
- Confirmado que `Papeles pintados para espacios pÃƒÂºblicos` conserva el contenido y los metadatos corregidos en ES, EN, FR, DE y NL.
- Confirmado que el blog raÃƒÂ­z `InspiraciÃƒÂ³n` conserva sus metatÃƒÂ­tulos y metadescripciones corregidos en ES, EN, FR, DE y NL.
- Todas las traducciones leÃƒÂ­das de estos tres recursos figuran como `outdated: false`.
- Se aÃƒÂ±adieron al backlog los bloqueos crÃƒÂ­ticos de pÃƒÂ¡ginas localizadas vacÃƒÂ­as, FAQ, Profesionales, footer, colecciones con prestaciones no verificadas y auditorÃƒÂ­a individual de artÃƒÂ­culos.
- Se corrigieron identificadores duplicados en `auditoria-catalogo.csv`; no implica ningÃƒÂºn cambio en el catÃƒÂ¡logo de Shopify.
- No se modificaron temas, menÃƒÂºs, URLs, redirecciones, productos, inventario ni publicaciones.

### Lote MW-SEO-011: Profesionales y FAQ gobernadas

**Estado:** contenido guardado corregido en ES, EN, FR, DE y NL; bloqueo pÃƒÂºblico de plantilla confirmado.

**Cambios ejecutados en Shopify:**

- Reescritos tÃƒÂ­tulo, cuerpo y metadatos de `Profesionales` en los cinco idiomas prioritarios.
- Retirados del contenido guardado descuentos, muestras gratuitas, envÃƒÂ­o prioritario, cantidades de catÃƒÂ¡logo, prestaciones tÃƒÂ©cnicas y respuesta en 24 horas no validadas.
- Reescritos tÃƒÂ­tulo, cuerpo y metadatos de `Preguntas frecuentes` en los cinco idiomas prioritarios.
- Retiradas del contenido guardado afirmaciones no validadas sobre materiales, lavabilidad, envÃƒÂ­o gratuito, plazos, pagos, financiaciÃƒÂ³n, garantÃƒÂ­as y devoluciones.
...
- No se modificaron handles, URLs, redirecciones, menÃƒÂºs, temas, productos ni estado de publicaciÃƒÂ³n.

**VerificaciÃƒÂ³n y bloqueo pÃƒÂºblico:**

- `Profesionales` usa `templates/page.profesionales.json`; MAIN y staging son idÃƒÂ©nticos, checksum `c02c11dc82a2d4ca90c756a5ae81d960`.
- `FAQ` usa `templates/page.faq.json`; MAIN y staging son idÃƒÂ©nticos, checksum `d515fbda6fcc75f79d06cdba2d7cc0dd`.
- Ambas plantillas contienen bloques de texto fijos que continÃƒÂºan apareciendo pÃƒÂºblicamente y no coinciden con el contenido editorial corregido.
- La FAQ pÃƒÂºblica sigue mostrando afirmaciones comerciales y polÃƒÂ­ticas que requieren validaciÃƒÂ³n.
- La pÃƒÂ¡gina pÃƒÂºblica de Profesionales sigue mostrando mensajes fijos sobre programa exclusivo, planes y ventajas.
- Ninguna de las dos URLs puede marcarse como completada hasta corregir y validar sus plantillas en un tema auxiliar.

### Lote MW-SEO-012: Colaboraciones, afiliaciÃƒÂ³n y prensa

**Estado:** contenido guardado corregido en ES, EN, FR, DE y NL; bloqueo pÃƒÂºblico de plantilla confirmado.

**Cambios ejecutados en Shopify:**

- Reescritos tÃƒÂ­tulo, cuerpo y metadatos de `social-prensa-y-afiliacion` en los cinco idiomas prioritarios.
- Convertida la pÃƒÂ¡gina en un punto de contacto para propuestas de colaboraciÃƒÂ³n, consultas de afiliaciÃƒÂ³n y solicitudes de prensa.
...
- Todas las traducciones registradas terminaron sin `userErrors` y con `outdated: false`.
- No se modificaron handles, URLs, redirecciones, menÃƒÂºs, temas ni estado de publicaciÃƒÂ³n.

**VerificaciÃƒÂ³n y bloqueo pÃƒÂºblico:**

- La pÃƒÂ¡gina usa `templates/page.social_prensa_afiliacion.json`.
- MAIN y staging son idÃƒÂ©nticos, checksum `78504a72d8cf077256e68dc4bbb1421f`, tamaÃƒÂ±o 17.323 bytes.
- La URL pÃƒÂºblica inglesa sigue mostrando bloques fijos con comisiones, mensajes de Ã¢â‚¬Å“start earningÃ¢â‚¬Â, testimonios y permiso amplio para usar imÃƒÂ¡genes.
- La URL no puede marcarse como completada hasta corregir y validar su plantilla en un tema auxiliar.

## 16 de junio de 2026

### Control MW-GOV-001: aplicaciÃƒÂ³n de AGENTS.md y conciliaciÃƒÂ³n del historial

**Estado:** `VERIFICADO PERO MEJORABLE`.

**Acciones locales realizadas:**

- LeÃƒÂ­do ÃƒÂ­ntegramente `AGENTS.md` y adoptado como protocolo permanente para el proyecto y sus subcarpetas.
- LeÃƒÂ­dos los 29 archivos existentes dentro de `auditoria-seo-geo-matchwalls`, incluidas todas las matrices CSV completas, inventario de 7.932 URLs, sitemap, evidencias, scripts y archivo Liquid del hotfix.
- Conciliados los documentos histÃƒÂ³ricos con el registro de cambios mÃƒÂ¡s reciente.
- No se ha modificado Shopify durante este control.

**Incidencia de gobernanza detectada:**

- Los lotes `MW-SEO-011` y `MW-SEO-012` estÃƒÂ¡n documentados como cambios ejecutados en Shopify.
- En los documentos del proyecto no consta la aprobaciÃƒÂ³n literal requerida por el protocolo: `APROBADO LOTE [NOMBRE]`.
- Esta ausencia de evidencia de aprobaciÃƒÂ³n se clasifica como `INCORRECTO` y `REQUIERE DECISION HUMANA`.
- No se ejecutarÃƒÂ¡ ninguna nueva mutaciÃƒÂ³n, ampliaciÃƒÂ³n, reversiÃƒÂ³n ni modificaciÃƒÂ³n relacionada sin un lote presentado y aprobado conforme a `AGENTS.md`.

**Diferencias histÃƒÂ³ricas relevantes:**

- Algunos documentos iniciales describen estados anteriores al acceso interno y a los lotes ejecutados; deben tratarse como evidencia histÃƒÂ³rica, no como estado actual.
- Estados antiguos como `Verificado`, `Parcialmente corregido` o `Corregido` no siguen exactamente la clasificaciÃƒÂ³n obligatoria definida despuÃƒÂ©s en `AGENTS.md`. Se conservarÃƒÂ¡n como histÃƒÂ³rico hasta aprobar una normalizaciÃƒÂ³n documental especÃƒÂ­fica.

**Siguiente acciÃƒÂ³n autorizada:**

- Contrastar exclusivamente mediante consultas de lectura el estado real actual de Shopify y presentar el prÃƒÂ³ximo lote recomendado.

### Control MW-GOV-002: verificaciÃƒÂ³n de solo lectura del estado actual de Shopify
...
- El hotfix aÃƒÂ±ade `snippets/microdata-schema-original.liquid`, copia exacta del schema MAIN con checksum `ae9c62e4abb80d1051cbea73b03f1107`.
- `snippets/microdata-schema.liquid` cambia de `ae9c62e4abb80d1051cbea73b03f1107` a `58417e4825aa3d4570a6646f292aaedc`.
- TambiÃƒÂ©n difieren `assets/country-flags.css`, `assets/sections.js` y `assets/theme.js`.
...
- Hasta completar esa clasificaciÃƒÂ³n y repetir QA visual y funcional, la publicaciÃƒÂ³n del hotfix se clasifica como `RIESGO CRITICO`.

**Schema verificado por lectura del cÃƒÂ³digo:**

- El MAIN todavÃƒÂ­a contiene `AggregateRating` corporativo fijo y publica como GTIN cualquier barcode de longitud compatible.
- El hotfix elimina el `AggregateRating` corporativo fijo, cambia el breadcrumb de artÃƒÂ­culo para usar el tÃƒÂ­tulo del artÃƒÂ­culo y omite GTIN/MPN cuando `barcode == variant.id`.
- En una muestra actual de los primeros 50 productos activos, los 193 barcodes de variante leÃƒÂ­dos coinciden exactamente con el ID numÃƒÂ©rico interno de su variante.
- La correcciÃƒÂ³n del hotfix para excluir estos identificadores internos se clasifica como `VERIFICADO Y CORRECTO` a nivel de cÃƒÂ³digo.
- La validaciÃƒÂ³n de ejecuciÃƒÂ³n completa en Rich Results, carrito, formularios, App Embeds, mÃƒÂ³vil y escritorio no se ha repetido en este control y se clasifica como `INCOMPLETO`.

**Contenido y traducciones prioritarias:**

- Las pÃƒÂ¡ginas Contacto, Muestras, GuÃƒÂ­a de instalaciÃƒÂ³n, FAQ, Social/Prensa/AfiliaciÃƒÂ³n, Sobre nosotros y Profesionales estÃƒÂ¡n publicadas.
- Sus registros de traducciÃƒÂ³n prioritarios EN, FR, DE y NL figuran como `outdated: false`.
- Esto verifica existencia y vigencia tÃƒÂ©cnica, pero no calidad editorial ni coincidencia con el contenido pÃƒÂºblico visible.
- Las plantillas de FAQ, Profesionales, Social/Prensa/AfiliaciÃƒÂ³n, Muestras y GuÃƒÂ­a de instalaciÃƒÂ³n son idÃƒÂ©nticas en MAIN, staging y hotfix; por tanto, los bloqueos de contenido fijo documentados continÃƒÂºan.
- Este estado se clasifica como `VERIFICADO PERO MEJORABLE` y, para las pÃƒÂ¡ginas bloqueadas por plantilla, `INCOMPLETO`.

**Idiomas publicados verificados:**

- ES es el idioma principal.
- EN, FR, DE, NL, IT y PT-PT estÃƒÂ¡n publicados.
- El resto de idiomas configurados consultados no estÃƒÂ¡ publicado.

**Recursos prioritarios verificados:**

- El producto personalizado, la colecciÃƒÂ³n de mÃƒÂ¡s vendidos, la colecciÃƒÂ³n de espacios pÃƒÂºblicos, la colecciÃƒÂ³n floral y el blog raÃƒÂ­z `InspiraciÃƒÂ³n` conservan los contenidos y metadatos documentados.
- Sus traducciones prioritarias consultadas figuran como `outdated: false`.

**DecisiÃƒÂ³n operativa:**

- No publicar el hotfix.
- No ampliar cambios editoriales ni de tema sin presentar un lote y recibir la aprobaciÃƒÂ³n literal exigida por `AGENTS.md`.

### Lote MW-QA-HOTFIX-001: QA integral del tema `SEO schema hotfix - 2026-06-15`

**AprobaciÃƒÂ³n recibida:** `APROBADO LOTE MW-QA-HOTFIX-001`.

**Estado final:** `VERIFICADO Y CORRECTO`.

**Alcance ejecutado:**

- ComparaciÃƒÂ³n MAIN vs hotfix.
- ValidaciÃƒÂ³n de schema en home, productos, artÃƒÂ­culos, carrito y formularios.
- RevisiÃƒÂ³n ES, EN, FR, DE y NL.
- QA escritorio y mÃƒÂ³vil.
- VerificaciÃƒÂ³n de App Embeds por `config/settings_data.json`.
...
- `assets/country-flags.css`, `assets/sections.js` y `assets/theme.js` tienen checksums distintos, pero son semÃƒÂ¡nticamente idÃƒÂ©nticos tras normalizar ID de tema y versiÃƒÂ³n CDN.
...
- ArtÃƒÂ­culo probado en ES, EN, FR, DE y NL: `BlogPosting` y `BreadcrumbList` parseables; tercer breadcrumb con tÃƒÂ­tulo real del artÃƒÂ­culo.
- Carrito, contacto y formulario de particulares renderizan sin errores JSON-LD.
- QA escritorio y mÃƒÂ³vil: sin regresiÃƒÂ³n funcional atribuible al hotfix.

**Incidencias no bloqueantes fuera del hotfix:**

- Carrito y formulario de particulares siguen sin H1.
- Algunos productos mantienen pequeÃƒÂ±o desbordamiento horizontal en mÃƒÂ³vil, ya observado en MAIN.
- ContinÃƒÂºan pendientes las traducciones deficientes DE/NL y los bloqueos de plantillas documentados en lotes anteriores.
...
- El hotfix queda tÃƒÂ©cnicamente recomendado para publicaciÃƒÂ³n manual.
- La publicaciÃƒÂ³n no estÃƒÂ¡ incluida en este lote y queda en `REQUIERE DECISION HUMANA`.
...
### Lote MW-PUBLISH-HOTFIX-001: intento de publicaciÃƒÂ³n del hotfix de schema

**AprobaciÃƒÂ³n recibida:** `APROBADO LOTE MW-PUBLISH-HOTFIX-001`.
...
- No publicar `SEO-GEO staging - 2026-06-15`.
- No modificar productos, colecciones, pÃƒÂ¡ginas, menÃƒÂºs, traducciones, apps, mercados, configuraciÃƒÂ³n general, URLs, handles, precios, inventario, imÃƒÂ¡genes ni variantes.
- No eliminar `snippets/microdata-schema-original.liquid`.
- Ejecutar QA post-publicaciÃƒÂ³n inmediato en ES, EN, FR, DE y NL solo si la publicaciÃƒÂ³n se completa.

**Estado pre-publicaciÃƒÂ³n verificado:**
...
- Se validÃƒÂ³ correctamente la mutaciÃƒÂ³n GraphQL `themePublish(id: ...)` contra el esquema Admin.
- Al ejecutarla, la conexiÃƒÂ³n de Shopify bloqueÃƒÂ³ la operaciÃƒÂ³n con el mensaje: publicar un tema estÃƒÂ¡ bloqueado y debe hacerse manualmente desde Shopify Admin para evitar cambios accidentales del storefront.
- Se intentÃƒÂ³ abrir Shopify Admin en navegador integrado: `https://admin.shopify.com/store/matchwalls/themes`.
- Shopify redirigiÃƒÂ³ a login: `accounts.shopify.com/lookup`.

**Resultado:**

- No se publicÃƒÂ³ ningÃƒÂºn tema.
- No se modificÃƒÂ³ Shopify.
- No se ejecutÃƒÂ³ QA post-publicaciÃƒÂ³n porque la publicaciÃƒÂ³n no se completÃƒÂ³.
- El tema hotfix permanece pendiente de publicaciÃƒÂ³n manual por Daniel desde Shopify Admin.

**Siguiente acciÃƒÂ³n humana requerida:**

- Daniel debe iniciar sesiÃƒÂ³n en Shopify Admin y publicar manualmente `SEO schema hotfix - 2026-06-15`, verificando que no selecciona `SEO-GEO staging - 2026-06-15`.
- Tras la publicaciÃƒÂ³n manual, se debe ejecutar inmediatamente el QA post-publicaciÃƒÂ³n definido en este lote.
...
### Lote MW-FOOTER-I18N-001: correcciÃƒÂ³n footer global en tema QA

**AprobaciÃƒÂ³n recibida:** `APROBADO LOTE MW-FOOTER-I18N-001`.

**Fecha:** 17 de junio de 2026.

**Modo:** ejecuciÃƒÂ³n acotada en tema no publicado.

**Acciones ejecutadas:**

- Consulta de respaldo del tema MAIN real `SEO schema hotfix - 2026-06-15`, ID `gid://shopify/OnlineStoreTheme/178383749496`.
- Consulta de menÃƒÂºs globales usados por footer: `footer`, `footer-profesional`, `footer-brand`, `footer-legal`.
- Consulta de recurso traducible del tema para comprobar existencia de claves de footer.
- CreaciÃƒÂ³n de respaldo local `respaldo-MW-FOOTER-I18N-001-2026-06-17.md`.
- Duplicado del tema MAIN mediante `themeDuplicate`.
- CreaciÃƒÂ³n de tema QA no publicado `MW-FOOTER-I18N-001 - QA - 2026-06-17`, ID `gid://shopify/OnlineStoreTheme/178390401400`.
- EdiciÃƒÂ³n mediante `themeFilesUpsert` solo del archivo `sections/footer-group.json` en el tema QA.
- Lectura posterior del archivo QA para confirmar valores almacenados.
- ComprobaciÃƒÂ³n de que el tema MAIN conserva el checksum original del footer.

**Cambios ejecutados en Shopify:**

- Tema QA no publicado creado.
- Archivo `sections/footer-group.json` actualizado ÃƒÂºnicamente en el tema QA.

**No ejecutado:**

- No se modificÃƒÂ³ el tema MAIN.
- No se publicÃƒÂ³ ningÃƒÂºn tema.
- No se modificaron menÃƒÂºs globales.
- No se registraron traducciones EN, FR, DE o NL.
- No se tocaron productos, colecciones, pÃƒÂ¡ginas, URLs, handles, redirecciones, precios, inventario, variantes, imÃƒÂ¡genes, App Embeds ni Liquid de producciÃƒÂ³n.

**Valores principales modificados en QA:**

- `EnvÃƒÂ­o gratuito` / `Worldwide.` -> `EnvÃƒÂ­o internacional` / `Consulta los plazos y condiciones de envÃƒÂ­o disponibles para tu paÃƒÂ­s.`
- `Pago seguro` / `Metodos de pago seguros y financiaciÃƒÂ³n.` -> `Pagos seguros` / `Consulta los mÃƒÂ©todos de pago disponibles en la pantalla de pago.`
- `GarantÃƒÂ­a de satisfacciÃƒÂ³n` / `Nuestro compromiso tu tranquilidad.` -> `AtenciÃƒÂ³n y soporte` / `Te ayudamos antes y despuÃƒÂ©s de tu pedido.`
- `PersonalizaciÃƒÂ³n` / `Te ayudamos a crear tu diseÃƒÂ±o Matchwalls.` -> `PersonalizaciÃƒÂ³n` / `Te orientamos para adaptar tu diseÃƒÂ±o a medida.`
- `FÃƒÂ¡cil instalaciÃƒÂ³n` / `Descargate nuestras guÃƒÂ­as de fÃƒÂ¡cil instlaciÃƒÂ³on.` -> `GuÃƒÂ­as de instalaciÃƒÂ³n` / `Consulta nuestras guÃƒÂ­as antes de instalar tu papel pintado o mural.`
- Newsletter superior corregida de `Se el primero... tips...` a una redacciÃƒÂ³n mÃƒÂ¡s limpia y conservadora.
...
- Resultado: la navegaciÃƒÂ³n termina en `https://www.matchwalls.com/` y muestra el tema vivo, no el tema QA.
- Por tanto, QA pÃƒÂºblica de preview: `NO ACCESIBLE` desde este entorno.

**Incidencias y lÃƒÂ­mites:**

- Los menÃƒÂºs globales siguen vivos con errores verificados: `FAQÃ‚Â´S`, `Black Friday 2024`, `espacios pÃƒÂºbicos`.
- Los menÃƒÂºs no se editaron porque impactan directamente el sitio publicado y no son theme-scoped.
- Las traducciones de tema EN/FR/DE/NL no se editaron porque falta inventario exacto filtrado de claves y `digest`.
- `0 userErrors` solo confirma aceptaciÃƒÂ³n tÃƒÂ©cnica por Shopify, no publicaciÃƒÂ³n ni QA visual pÃƒÂºblica.
...
- MenÃƒÂºs globales: `INCORRECTO`.
- Traducciones EN/FR/DE/NL del footer: `INCOMPLETO`.
- PublicaciÃƒÂ³n: `NO EJECUTADA`.


### Lote MW-FOOTER-NAV-GLOBAL-002: reparaciÃƒÂ³n navegaciÃƒÂ³n footer publicada

**AprobaciÃƒÂ³n recibida:** `APROBADO LOTE MW-FOOTER-NAV-GLOBAL-002`.

**Fecha:** 17 de junio de 2026.

**Modo:** ediciÃƒÂ³n acotada de menÃƒÂºs globales publicados.

**Acciones ejecutadas:**

- Lectura previa de menÃƒÂºs `footer`, `footer-profesional`, `footer-brand` y `footer-legal`.
- CreaciÃƒÂ³n de respaldo local `respaldo-MW-FOOTER-NAV-GLOBAL-002-2026-06-17.md`.
- ValidaciÃƒÂ³n GraphQL de la mutaciÃƒÂ³n `menuUpdate`.
- EjecuciÃƒÂ³n de `menuUpdate` en cuatro menÃƒÂºs globales.
- Lectura posterior vÃƒÂ­a Shopify Admin.
- QA pÃƒÂºblica del footer en ES, EN, FR, DE y NL.

**Cambios ejecutados en Shopify:**

- `footer`: retirados `EnvÃƒÂ­os internacionales` y `Black Friday 2024`; etiquetas fuente corregidas.
- `footer-profesional`: corregida errata `espacios pÃƒÂºbicos` -> `espacios pÃƒÂºblicos`; etiquetas B2B normalizadas.
- `footer-brand`: retirado `Tarjeta regalo`; etiquetas `Sobre nosotros` y `Nuestros productos` normalizadas.
- `footer-legal`: capitalizaciÃƒÂ³n editorial corregida.

**No ejecutado:**

- No se modificaron temas.
- No se publicÃƒÂ³ ningÃƒÂºn tema.
- No se eliminaron pÃƒÂ¡ginas, productos ni colecciones.
- No se cambiaron URLs, handles ni redirecciones.
- No se modificaron precios, inventario, variantes, imÃƒÂ¡genes ni App Embeds.
...
- Lectura posterior confirma que:
  - `footer` ya no contiene `EnvÃƒÂ­os internacionales` ni `Black Friday 2024`.
  - `footer-brand` ya no contiene `Tarjeta regalo`.
  - `footer-profesional` usa `espacios pÃƒÂºblicos`.
  - `footer` usa `FAQ - EnvÃƒÂ­os y devoluciones`.

**QA pÃƒÂºblica:**

- ES: corregido y verificado para enlaces retirados y etiquetas fuente.
- EN: enlaces retirados no aparecen, pero persiste traducciÃƒÂ³n antigua `FAQÃ‚Â´S - Shipping and Returns` y otras traducciones mejorables.
- FR: enlaces retirados no aparecen; persisten cabeceras fuente espaÃƒÂ±olas y traducciones mejorables.
- DE: enlaces retirados no aparecen; persisten traducciones mejorables.
- NL: enlaces retirados no aparecen; persisten cabeceras fuente espaÃƒÂ±olas, `FAQÃ‚Â´s` y traducciÃƒÂ³n incorrecta `schaamruimtes`.

**Estado final:**

- `Tarjeta regalo`: `CORREGIDO Y VERIFICADO`.
- `Black Friday 2024`: `CORREGIDO Y VERIFICADO`.
- `EnvÃƒÂ­os internacionales`: `CORREGIDO Y VERIFICADO`.
- MenÃƒÂºs fuente ES: `CORREGIDO Y VERIFICADO`.
- Traducciones de navegaciÃƒÂ³n EN/FR/DE/NL: `INCOMPLETO`.
...
### Lote MW-FOOTER-I18N-TRANSLATIONS-003: traducciones navegaciÃƒÂ³n footer EN/FR/DE/NL

**AprobaciÃƒÂ³n recibida:** `APROBADO LOTE MW-FOOTER-I18N-TRANSLATIONS-003`.
...
- Consulta previa de recursos traducibles de los cuatro menÃƒÂºs de footer.
- IdentificaciÃƒÂ³n de tÃƒÂ­tulos de menÃƒÂº como recursos `MENU`.
- IdentificaciÃƒÂ³n de enlaces de menÃƒÂº como recursos `LINK`.
- ConfirmaciÃƒÂ³n de que los IDs `MenuItem` no son vÃƒÂ¡lidos para `translatableResourcesByIds`.
- CreaciÃƒÂ³n de respaldo local `respaldo-MW-FOOTER-I18N-TRANSLATIONS-003-2026-06-17.md`.
- ValidaciÃƒÂ³n GraphQL de la mutaciÃƒÂ³n `translationsRegister`.
- Registro de 96 traducciones EN/FR/DE/NL en 24 recursos.
- Lectura posterior por Shopify Admin.
- VerificaciÃƒÂ³n de configuraciÃƒÂ³n de publicaciÃƒÂ³n de idiomas, Markets/web presence, tema MAIN y App Embed LangShop.
...
- Lectura posterior confirmÃƒÂ³ traducciones EN/FR/DE/NL con `outdated:false`.
- `Menu.translations` confirmÃƒÂ³ tÃƒÂ­tulos de menÃƒÂº publicados con valores corregidos.

**ConfiguraciÃƒÂ³n de publicaciÃƒÂ³n verificada:**
...
- ConfiguraciÃƒÂ³n interna LangShop: `NO ACCESIBLE`.
- `appInstallations` devuelve `access denied`; no se pudo verificar plan, reglas, glosario, auto-sync ni cola de publicaciÃƒÂ³n.

**QA pÃƒÂºblica:**

- Navegador interno: `https://www.matchwalls.com/en/` devolviÃƒÂ³ pÃƒÂ¡gina Shopify de error `Algo saliÃƒÂ³ mal`.
- `Invoke-WebRequest`: error de recepciÃƒÂ³n.
- `curl.exe -I`: no pudo conectar a `www.matchwalls.com:443` vÃƒÂ­a `127.0.0.1`.
- Render pÃƒÂºblico desde este entorno: `NO ACCESIBLE`.

**No ejecutado:**

- No se modificaron temas.
- No se publicaron temas.
- No se modificaron menÃƒÂºs fuente ES.
- No se cambiaron productos, colecciones, pÃƒÂ¡ginas, handles, URLs, redirecciones, precios, inventario, variantes, imÃƒÂ¡genes ni App Embeds.
- No se modificÃƒÂ³ configuraciÃƒÂ³n LangShop.
- No se ejecutaron traducciones automÃƒÂ¡ticas.

**Estado final por capa:**

- Traducciones almacenadas en Shopify Admin: `CORREGIDO Y VERIFICADO`.
- ConfiguraciÃƒÂ³n Shopify para publicaciÃƒÂ³n EN/FR/DE/NL: `VERIFICADO Y CORRECTO`.
- LangShop App Embed activo: `VERIFICADO PERO MEJORABLE`.
- ConfiguraciÃƒÂ³n interna LangShop: `NO ACCESIBLE`.
- Render pÃƒÂºblico storefront: `NO ACCESIBLE`.
...
- El HTML publico externo de `https://www.matchwalls.com/` sigue mostrando residuos equivalentes como `Envios internacionales` / `EnvÃƒÂ­os internacionales` y `Black Friday 2024`.
...
- Ejemplo Shopify Admin: producto `LÃƒÂ­neas NÃƒÂ³rdicas Negro`, ID `gid://shopify/Product/8474101645539`, handle `lineas-noridcas-negro`, estado `ACTIVE`.
...
- Pagina `Sobre Nosotros Ã¢â‚¬â€ MatchWalls, expertos en papel pintado mural`, ID `gid://shopify/Page/106231464163`, publicada.
...
- Daniel confirmÃƒÂ³ la eliminaciÃƒÂ³n manual del tema autorizado.
- Consulta Shopify posterior: 19 temas; paginaciÃƒÂ³n completa.
- `gid://shopify/OnlineStoreTheme/142344224995` devuelve `null`.
- No se eliminÃƒÂ³ ningÃƒÂºn otro tema dentro del lote.
...
- MAIN `178396463480`: rol `MAIN`, prefijo `/t/45`, procesamiento finalizado
  sin fallo.
- ReversiÃƒÂ³n `178383749496`: rol `UNPUBLISHED`, prefijo `/t/43`, procesamiento
...
- Home, producto, colecciÃƒÂ³n y carrito comprobados en escritorio y mÃƒÂ³vil.
- 8/8 cargas sirven recursos de `/t/45`, tienen contenido y no presentan 404.
- La portada mÃƒÂ³vil necesitÃƒÂ³ repeticiÃƒÂ³n por carga transitoria; la repeticiÃƒÂ³n fue
...
- El producto representativo mostrÃƒÂ³ overflow mÃƒÂ³vil `427/375`; se incorpora al
  diagnÃƒÂ³stico de deuda tÃƒÂ©cnica.
- El carrito no mostrÃƒÂ³ H1 en el smoke test; no se alterÃƒÂ³ el MAIN y se revisarÃƒÂ¡
  por separado.
...
- ZIP verificado y archivado en
  `backups/MW-THEME-LIBRARY-CLEANUP-009B-2026-06-18/`.
- ReversiÃƒÂ³n: importar el ZIP como tema nuevo `UNPUBLISHED` y contrastar 289
  archivos; Shopify asignarÃƒÂ¡ un ID nuevo.
...
- Los elementos `external-width` y `external-height` no existen en la mayorÃƒÂ­a
  de pÃƒÂ¡ginas, pero el cÃƒÂ³digo invoca sus listeners sin comprobarlos.
- No se modificÃƒÂ³ Shopify.

---

# 2026-06-19 08:01:02 +02:00 - EjecuciÃƒÂ³n y QA parcial 010A5

`INCOMPLETO`

- AprobaciÃƒÂ³n exacta recibida y aplicada solo al auxiliar `178399019384`.
- `assets/customizer.js`: MD5 `6684ed205824c8ba660bd4c67a5e26fc`,
  40832 bytes, guard 1 y cero `userErrors`.
- MAIN y reversiÃƒÂ³n no modificados.
- ComparaciÃƒÂ³n funcional con MAIN: 400Ãƒâ€”300 cm, cantidad 12 y precio 402 Ã¢â€šÂ¬.
- QA especÃƒÂ­fica: 20/20, ES/EN/FR/DE/NL, escritorio/mÃƒÂ³vil.
- Matriz mÃƒÂ³vil: 85/85.
...
- Pendiente completar 74 verificaciones de escritorio vÃƒÂ¡lidas.
...
- Matriz final: mÃƒÂ³vil 85/85 y escritorio 85/85; total 170/170.
- QA especÃƒÂ­fica: 20/20.
- Medidas, cantidad y precio equivalentes a MAIN: 400Ãƒâ€”300 cm, 12 y 402 Ã¢â€šÂ¬.
...
- MAIN no modificado. No se publicÃƒÂ³ ningÃƒÂºn tema.

## Propuesta

- Duplicar MAIN como tema auxiliar `UNPUBLISHED`.
- AÃƒÂ±adir guardas independientes a ambos listeners en un solo archivo.
...
- AprobaciÃƒÂ³n exacta recibida.
- Preflight: 19 temas; MAIN `178396463480`; reversiÃƒÂ³n `178383749496`.
...
- Modificado ÃƒÂºnicamente `snippets/srolling_bar_menu.liquid` en el auxiliar.
...
- Escritorio 85/85 y mÃƒÂ³vil 85/85 pruebas crÃƒÂ­ticas correctas.
- 170/170: `/t/46`, H1, canonical, cinco hreflang, `html lang`, indexabilidad,
  contenido y ausencia de 404.
- Error `addEventListener`: 0/170.
- Primera pasada: propagaciÃƒÂ³n tardÃƒÂ­a en 70 H1; repeticiÃƒÂ³n 70/70 correcta.

## Incidencias independientes

`VERIFICADO PERO MEJORABLE`

- Overflow mÃƒÂ³vil: FR 17, NL 16, resto 0.
...
- MAIN original: tambiÃƒÂ©n 0 eventos y reproduce la excepciÃƒÂ³n original.
- Causa: campos insertados despuÃƒÂ©s de `DOMContentLoaded`; no es regresiÃƒÂ³n de
  010A, pero el criterio funcional no se cumple.
- Auxiliar permanece `UNPUBLISHED`; no se publicÃƒÂ³ ni se modificÃƒÂ³ el MAIN.
...
- MAIN y reversiÃƒÂ³n intactos.

## Operacion

- Listener delegado almacenado ÃƒÂºnicamente en
...
- El campo interno sÃƒÂ­ recibiÃƒÂ³ el valor externo, por lo que la entrada fue real.
...
- No se ejecutaron las 170 pruebas al fallar la prueba crÃƒÂ­tica inicial.

## Nuevo hallazgo

`INCORRECTO`

- Producto estÃƒÂ¡ndar: `#customImage` inexistente.
...
- Una ÃƒÂºnica llamada directa objetivo; candidato cambia un solo carÃƒÂ¡cter.
- MAIN y reversiÃƒÂ³n intactos.
...
- El conector Shopify bloqueÃƒÂ³ dos escrituras del archivo de 49 KB.
...
- Shopify CLI no estÃƒÂ¡ instalado; no se instalÃƒÂ³ software.
- El editor Admin no fue controlable desde el navegador integrado.

## Estado actual

- Shopify no ha sido modificado por 010A3.
- Pendiente ediciÃƒÂ³n manual de un carÃƒÂ¡cter en el auxiliar aprobado.
...
- Daniel indicÃƒÂ³ `GUARDADO 010A3`.
...
- No se iniciÃƒÂ³ QA porque Shopify no almacenÃƒÂ³ el cambio.
- MAIN y reversiÃƒÂ³n permanecen intactos; no se publicÃƒÂ³ ningÃƒÂºn tema.

## 2026-06-18 21:42:23 +02:00 - Segunda verificacion manual 010A3

`INCOMPLETO`

- Daniel indicÃƒÂ³ `GUARDADO 010A3 EN 178399019384`.
...
- No se iniciÃƒÂ³ QA y no se publicÃƒÂ³ ningÃƒÂºn tema.
...
- Diferencia exacta: un `?`; tamaÃƒÂ±o +1 byte.
...
- 20 cargas: producto estÃƒÂ¡ndar y cargador Ãƒâ€” cinco idiomas Ãƒâ€” desktop/mÃƒÂ³vil.
- `/t/46`, contenido y ausencia de 404: 20/20.
- Producto estÃƒÂ¡ndar: error `addEventListener` 0/10.
- Cargador: error `addEventListener` 10/10.
- Seis cargas incompletas no se repitieron al persistir el fallo crÃƒÂ­tico.
- No se ejecutÃƒÂ³ la matriz de 170.
...
- Archivo: `snippets/product-customizer.liquid`, lÃƒÂ­nea local 605.
...
- Pendiente ediciÃƒÂ³n manual de un ÃƒÂºnico carÃƒÂ¡cter en el archivo ya abierto por
  Daniel. No se ha publicado ni se ha modificado el MAIN.

---

# 2026-06-18 23:01:11 +02:00 - VerificaciÃƒÂ³n tras ediciÃƒÂ³n manual 010A4

## Cambio almacenado

`VERIFICADO Y CORRECTO`

- Daniel indicÃƒÂ³ `GUARDADO Y CONFIRMADO 010A4` y aportÃƒÂ³ captura del cambio.
- Tema `178399019384`, `/t/46`, `UNPUBLISHED`.
- Archivo `snippets/product-customizer.liquid`.
- Checksum Shopify `d5a74ccb15b645eeb79e8c52f7c5a4ac`; tamaÃƒÂ±o `49230`.
- El checksum y tamaÃƒÂ±o coinciden exactamente con el candidato local calculado.
- Resultado acumulado: `fileInput?.addEventListener` 1,
  `openModalButton?.addEventListener` 1 y llamada directa objetivo 0.
- MAIN `178396463480` y reversiÃƒÂ³n `178383749496` conservan checksum
  `3878a24a9bb6cb134247ac6aff707a58` y tamaÃƒÂ±o `49228`.
- Los 20 temas siguen presentes; no se publicÃƒÂ³, duplicÃƒÂ³, renombrÃƒÂ³ ni eliminÃƒÂ³
  ningÃƒÂºn tema.
...
- Producto estÃƒÂ¡ndar ES de escritorio cargado desde recursos `/t/46`.
...
- La polÃƒÂ­tica del navegador rechazÃƒÂ³ continuar las siguientes navegaciones.
- Pruebas especÃƒÂ­ficas completadas: 1/20; matriz completa: 0/170.
...
- El cambio de cÃƒÂ³digo estÃƒÂ¡ verificado, pero falta la QA dinÃƒÂ¡mica obligatoria.
- Tema auxiliar permanece `UNPUBLISHED`; MAIN no modificado.
- ReversiÃƒÂ³n exacta: retirar el segundo `?` y recuperar checksum
...
## QA especÃƒÂ­fica completada

`CORREGIDO Y VERIFICADO`

- Producto estÃƒÂ¡ndar y cargador en ES/EN/FR/DE/NL, escritorio y mÃƒÂ³vil: 20/20.
- Tema `/t/46`, H1 ÃƒÂºnico, contenido y ausencia de 404: 20/20.
- `#customImage`: 0/10 estÃƒÂ¡ndar y 10/10 cargador, comportamiento esperado.
...
- 85 URLs por escritorio y mÃƒÂ³vil: 170/170.
- H1 exacto y ÃƒÂºnico, canonical propio, cinco hreflang, idioma HTML, ausencia
  de `noindex`, contenido, ausencia de 404 y recursos `/t/46`: correctos.
- Error `addEventListener`: 0.
- Fallos crÃƒÂ­ticos: 0.

## Deudas separadas

`VERIFICADO PERO MEJORABLE`

- Desbordamiento mÃƒÂ³vil: 34/85, distribuido en 17 FR y 17 NL.
- El histÃƒÂ³rico inmediato era 33/85; se analizarÃƒÂ¡ la diferencia dentro del
  sublote especÃƒÂ­fico de overflow.
...
- Tema auxiliar `178399019384` continÃƒÂºa sin publicar.
- MAIN no fue modificado.
- ReversiÃƒÂ³n: retirar el segundo `?` y recuperar MD5
  `8f8a7d213f04ace77c4003647053f763`.
- Evidencia: `qa-MW-TECH-UPLOADER-OPENMODAL-GUARD-010A4-2026-06-18.md`.

---

# 2026-06-18 23:47:36 +02:00 - DecisiÃƒÂ³n de alcance de buscadores e IA
...
- Sistemas IA prioritarios: Copilot, Perplexity, Gemini, Claude, Grok y
  ChatGPT.
- La mediciÃƒÂ³n agrupa las dependencias operativas cuando proceda, pero conserva
  resultados separados por superficie.
- No se modificÃƒÂ³ Shopify ni ninguna plataforma externa.

---

# 2026-06-18 23:54:38 +02:00 - DiagnÃƒÂ³stico 010A5

`VERIFICADO Y CORRECTO`

- `assets/customizer.js` coincide en auxiliar, MAIN y reversiÃƒÂ³n: MD5
  `2a26be9d6af37a992526274df431deaa`.
- Llamada `convertToInches()` presente; mÃƒÂ©todo inexistente.
- Ocho versiones histÃƒÂ³ricas confirman el defecto y no aportan implementaciÃƒÂ³n.
- Eliminar solo la llamada serÃƒÂ­a inseguro por `unitConverter()` y los campos
  imperiales a cero.
- Candidato con guard validado sintÃƒÂ¡cticamente; MD5
  `6684ed205824c8ba660bd4c67a5e26fc`.
- Propuesta: `propuesta-lote-MW-TECH-CUSTOMIZER-CONVERT-INCHES-010A5-2026-06-18.md`.
- No se modificÃƒÂ³ Shopify.
# 2026-06-19 - DiagnÃƒÂ³stico MW-TECH-NL-SYNTAX-010B
...
- MAIN `178396463480` y reversiÃƒÂ³n `178383749496` conservan exactamente el mismo
  archivo; no fueron modificados.
- `SyntaxError: Unexpected token ','` reproducido en ES, EN, FR, DE y NL en
  las cinco pÃƒÂ¡ginas localizadas Ã‚Â«Nuestros productosÃ‚Â».
- JavaScript invÃƒÂ¡lido localizado: `variant_id: ,`.
...
- Candidato: dos condiciones
  `request.page_type == 'product'` y una condiciÃƒÂ³n inversa equivalente.
- MD5 candidato `792a7f2c37022db342e1d7a82a8d3679`; 57177 bytes.
- Propuesta formal:
  `propuesta-lote-MW-TECH-NL-SYNTAX-010B-2026-06-19.md`.
- No se modificÃƒÂ³ Shopify. Pendiente aprobaciÃƒÂ³n exacta.

## Estado

`INCOMPLETO`

- PrÃƒÂ³ximo paso: recibir
  `APROBADO LOTE MW-TECH-NL-SYNTAX-010B`, ejecutar solo en el auxiliar y
  completar 20 pruebas especÃƒÂ­ficas mÃƒÂ¡s 170 de regresiÃƒÂ³n.

---

# 2026-06-20 11:29:21 +02:00 - Cierre MW-TECH-NL-SYNTAX-010B

## AprobaciÃƒÂ³n y ejecuciÃƒÂ³n

`CORREGIDO Y VERIFICADO`

- AprobaciÃƒÂ³n exacta recibida dos veces; se ejecutÃƒÂ³ una sola mutaciÃƒÂ³n.
- Tema auxiliar `178399019384`, `/t/46`, `UNPUBLISHED`.
...
- QA especÃƒÂ­fica ES/EN/FR/DE/NL, escritorio y mÃƒÂ³vil: 20/20.
- RegresiÃƒÂ³n: escritorio 85/85 y mÃƒÂ³vil 85/85; total 170/170.
- `SyntaxError: Unexpected token ','`: 0.
- `variant_id: ,`: 0; productos con variante numÃƒÂ©rica.
- Errores crÃƒÂ­ticos nuevos: 0.
...
- Overflow mÃƒÂ³vil: `VERIFICADO PERO MEJORABLE`; 34/85, 17 FR y 17 NL, igual que
  la lÃƒÂ­nea base.
- Validador Liquid empaquetado: `NO ACCESIBLE` por dependencia ausente; no se
  declarÃƒÂ³ como superado.

## ReversiÃƒÂ³n y evidencia
...
# 2026-06-20 - DiagnÃƒÂ³stico MW-TECH-MOBILE-OVERFLOW-FR-NL-010C

`VERIFICADO Y CORRECTO`

- Tema auxiliar `178399019384`, `/t/46`, `UNPUBLISHED`.
- `assets/theme.css` coincide en auxiliar, MAIN, reversiÃƒÂ³n y copia local: MD5
...
- Causa global: 96 px de margen derecho aplicado tambiÃƒÂ©n al ÃƒÂºltimo enlace legal
  del footer.
- Causa adicional NL `/nl/pages/onze-producten`: palabra
  `Aanpassingsdiensten` de 385 px dentro de un grid de 335 px.
- Candidato de un solo archivo: media query mÃƒÂ³vil de 270 bytes.
...
- Pendiente aprobaciÃƒÂ³n exacta, ejecuciÃƒÂ³n en auxiliar y 204 renders de QA.

---

---

# 2026-06-25 - EjecuciÃƒÂ³n y reversiÃƒÂ³n MW-TECH-MOBILE-OVERFLOW-FR-NL-010C
...
`VERIFICADO Y CORRECTO` como ejecuciÃƒÂ³n almacenada inicial.

- Se aÃƒÂ±adiÃƒÂ³ el bloque CSS aprobado en el editor de cÃƒÂ³digo de Shopify.
- Preview confirmÃƒÂ³ recursos `/t/46`.
- El ÃƒÂºltimo enlace legal pasÃƒÂ³ a `margin-right: 0px` con el candidato activo.
...
- FR `https://www.matchwalls.com/fr/pages/tout-sur-nos-peintures-murales` a viewport 390:
  ...
  - Errores crÃƒÂ­ticos de consola: 0.
...
## DiagnÃƒÂ³stico posterior

`INCORRECTO`

- La regla aprobada solo retiraba el margen del ÃƒÂºltimo enlace legal.
- Los tres primeros `.custom-legal__item` mantenÃƒÂ­an `margin-right: 96px`.
...
- Se eliminÃƒÂ³ el bloque 010C del editor de cÃƒÂ³digo.
- Antes de guardar: reglas 010C ausentes, `.facade-wrapper` presente y editor `No Problems`.
- Tras guardar, preview `/t/46` confirmÃƒÂ³ vuelta a lÃƒÂ­nea base:
  - FR: ÃƒÂºltimo enlace legal `margin-right: 96px`, overflow `+33 px`.
  - NL `/nl/pages/onze-producten`: ÃƒÂºltimo enlace legal `margin-right: 96px`, overflow `+30 px`.
...
- AprobaciÃƒÂ³n exacta recibida: `APROBADO LOTE MW-TECH-MOBILE-OVERFLOW-LEGAL-FLEX-010C2`.
- Tema auxiliar `178399019384`, `/t/46`, `UNPUBLISHED`.
- Archivo objetivo: `assets/theme.css`.
- MAIN `178396463480` no fue modificado ni publicado.
- Tema de reversiÃƒÂ³n `178383749496` no fue modificado.
- Exclusiones respetadas: URLs, handles, textos, traducciones, productos, precios, apps externas, tracking y publicaciÃƒÂ³n.

## Cambio ejecutado

`CORREGIDO Y VERIFICADO`

- MD5 auxiliar antes: `05810cc93feb785cc81aed10513a297a`; tamaÃƒÂ±o `241969` bytes.
- MD5 auxiliar despuÃƒÂ©s: `b86a0e260263eed6a2586a3e7bca8e05`; tamaÃƒÂ±o `242427` bytes.
- Se aÃƒÂ±adiÃƒÂ³ el bloque CSS 010C2 exacto una sola vez.
- `.custom-legal__item:last-child` del candidato fallido 010C sigue ausente.
- MAIN y tema de reversiÃƒÂ³n conservan MD5 `89f4729809a0eaac75a764e0fc41888e` y no contienen el bloque 010C2.
...
- FR/NL a 390 px: 34/34 correctas; overflow mÃƒÂ¡ximo `0 px`.
- FR/NL a 375 px: 34/34 correctas; overflow mÃƒÂ¡ximo `0 px`.
- Controles ES/EN/DE a 375 px: 51/51 correctas; overflow mÃƒÂ¡ximo `0 px`.
- Matriz mÃƒÂ³vil total: 85/85 correctas.
- Matriz desktop 1440 px: 85/85 correctas.
- Total estÃƒÂ¡ndar verificado: 170/170.
- H1, canonical, hreflang prioritarios, `html lang`, noindex, contenido, recursos `/t/46` y errores crÃƒÂ­ticos de consola: correctos en matriz.

## ReversiÃƒÂ³n

`VERIFICADO Y CORRECTO`

- ReversiÃƒÂ³n exacta: retirar ÃƒÂºnicamente el bloque 010C2 aÃƒÂ±adido en `assets/theme.css`.
- Objetivo de reversiÃƒÂ³n del auxiliar: MD5 `05810cc93feb785cc81aed10513a297a`.
